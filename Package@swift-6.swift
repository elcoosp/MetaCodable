...
let package = Package(
    ...
    dependencies: [
        ...
        .package(
            ...
            from: "1.2.2"),
        .package(
            url: "https://github.com/swiftlang/swift-format", from: "600.0.0"),
    ],
    targets: [
        // MARK: Core
        .target(
        ...
        .executableTarget(
            ...
            dependencies: [
                ...
                .product(
                    name: "SwiftSyntaxMacroExpansion", package: "swift-syntax"),
            ]
        ),
        .plugin(
...
if Context.environment["METACODABLE_BEING_USED_FROM_COCOAPODS"] != nil {
    ...
    package.products.append(
        .executable(name: "MacroPlugin", targets: ["MacroPlugin"]))
